...
class Entrie extends Model
{
    ...
    public function getLastLoginInformation(){
        return $this
       ->select('id','login_date_time','logout_date_time')
    ...
    public function logout(){
        ...
        ->orderBy('id' , 'desc')
        ->first();
        return Entrie::where('id' , $LastID->id)->update([
    ...
    public function gettUserWorkTimespecificMonth($month,$year , $id){
    ...
    public function gettUserWorkTimespecificDate($request , $id){
        ...
        ->select('login_date_time' , 'logout_date_time')
        ->where('user_id' , $id)
        ->whereDate('login_date_time' , $request)
        ->get();
