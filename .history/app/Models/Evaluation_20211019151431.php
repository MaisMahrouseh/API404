...
class Evaluation extends Model
{
    ...
    public function gettUserEvaluationspecificMonth($month, $year,$id){
        $UserEvaluation = $this
...
public function gettUserEvaluationspecificDate($request ,$id){
    $UserEvaluation = $this
    ->select('evaluation' , 'evaluation_date')
    ->where('user_id' , $id)
    ->whereDate('evaluation_date' ,$request->date)
    ->get();
