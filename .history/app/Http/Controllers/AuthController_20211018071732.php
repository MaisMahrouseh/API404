...
class AuthController extends Controller
{
    ...
    public function login(LoginUserRequest $request){
        ...
        if($LastLoginInformation == null || $LastLoginInformation->logout_date_time != null ){
           ...
           if($LastLoginInformation->logout_date_time == null && $LastLoginInformation->login_date_time->format('Y-m-d')  != $currentday)
           return $this->response->returnError('Please enter your exit time in' .$LastLoginInformation->login_date_time  , 403);
           ...
           if($LastAbsenceDate == null){
               if($LastLoginInformation->status == 1 && Carbon::parse$9LastLoginInformation->login_date_time < Carbon::today()){
