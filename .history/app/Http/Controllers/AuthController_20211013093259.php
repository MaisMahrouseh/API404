...
class AuthController extends Controller
{
    ...
    public function login(LoginUserRequest $request){
        ...
        if($LastLoginInformation === null ){
           ...
           $day = Carbon::parse($LastLoginInformation->login_date_time)->addDays(1)->isoFormat('dddd');
           $currentday = Carbon::today()->isoFormat('dddd');
           if ($day == 'Friday'){
           $day = Carbon::parse($LastLoginInformation->login_date_time)->addDays(2)->isoFormat('dddd');
            }
